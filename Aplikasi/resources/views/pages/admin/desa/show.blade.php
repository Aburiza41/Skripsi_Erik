    ...
    <x-slot name="footerScript">
        ...
        <script>
            const guestLand = (function() {
                var l = L.geoJson();
                $.getJSON("{{ asset('storage/' . $desa->koordinat_bidang_desa) }}", function(j) {
                    l.addData(j);
                });
                return l;
            }());
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-12">
                    <h1 class="h3 mb-2 text-gray-800">Peta {{ $desa->nama_desa }}</h1>
                ...
                <div class="col-xl-6 col-md-12 d-flex justify-content-end">
                    <div class="my-5">
                        <a class="btn btn-primary" href="{{ route('adminDesa') }}"><i class="fas fa-arrow-left"></i></a>
                        <a class="btn btn-primary ml-1" href="{{ route('adminDesaCreate') }}"><i
                                class="fas fa-plus"></i></a>
                        <a class="btn btn-primary ml-1" href="{{ route('adminDesaEdit', ['id' => $desa->id]) }}"><i
                                class="fas fa-edit"></i></a>
                        <a class="btn btn-danger ml-1" href="{{ route('adminDesaDestroy', ['id' => $desa->id]) }}"><i
