        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Ubah Data Kecamatan</h1>
                    {{-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> --}}
                </div>

                <!-- Content Row -->
                <form action="{{ route('adminKecamatanUpdate', ['id' => $kecamatan->id]) }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 my-1">
                            <label for="">Koordinat Bidang Kecamtan</label>
                            <input type="file" id="koordinat_bidang_kecamatan" name="koordinat_bidang_kecamatan"
                                class="form-control @error('koordinat_bidang_kecamatan') is-invalid @enderror">
                        </div>
